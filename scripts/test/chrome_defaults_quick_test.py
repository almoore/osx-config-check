...
class ReadCommandTest(unittest.TestCase):
    ...
    def test_read_simple_string_val(self):
        ...
        sample_json = {"str": "val"}
        self.assertEqual(
            chrome_defaults.get_json_field(sample_json, "str"), "val"
        )
    ...
    def test_read_simple_bool_val(self):
        ...
        self.assertEqual(
            chrome_defaults.get_json_field(sample_json, "bool"), False
        )
...
class WriteCommandTest(unittest.TestCase):
    ...
    def test_overwrite_nested_int(self):
        ...
        result = chrome_defaults._recursive_write(
            sample_json, "level1.level2.level3.int", 11
        )
    ...
    def test_write_to_sub_attrib_of_missing_obj(self):
        ...
        self.assertEqual(
            result["level1"]["level2"]["level3"]["level4"]["str"], "val"
        )
    ...
    def test_write_nested_attrib_with_json(self):
        ...
        self.assertEqual(
            result["level1"]["level2"]["level3"]["level4"][0]["val"], 1
        )
        self.assertEqual(
        ...
        self.assertEqual(
            result["level1"]["level2"]["level3"]["level4"][1]["val"], 2
        )
        ...
        sample_json = {
            "plugins": {
                "plugin_list": [
                    ...
                    {"enabled": True, "name": "Shockwave Flash"},
                ]
            }
        }
